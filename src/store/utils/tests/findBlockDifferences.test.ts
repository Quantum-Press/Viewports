 ...
 */
/*
test( 'can findBlockDifferences() when removing a nested style property, restricting the viewport style before > without changes', () => {
	const state = deepFreeze( {
		... DEFAULT_STATE,
		iframeViewport: 1280,
		valids: {
...
test( 'can findBlockDifferences() when removing a nested style property, restricting the viewport style before > with changes', () => {
	const state = deepFreeze( {
		... DEFAULT_STATE,
		iframeViewport: 1280,
		valids: {
...
test( 'can findBlockDifferences() when changing a single value between unchanged', () => {
	const state = deepFreeze( {
		... DEFAULT_STATE,
		iframeViewport: 1024,
		viewports: {
