...
namespace QP\Viewports\Vendor\Inpsyde\Modularity;

use QP\Viewports\Vendor\Inpsyde\Modularity\Container\ContainerConfigurator;
use QP\Viewports\Vendor\Inpsyde\Modularity\Container\PackageProxyContainer;
...
use QP\Viewports\Vendor\Inpsyde\Modularity\Module\FactoryModule;
use QP\Viewports\Vendor\Inpsyde\Modularity\Module\Module;
use QP\Viewports\Vendor\Inpsyde\Modularity\Module\ServiceModule;
use QP\Viewports\Vendor\Inpsyde\Modularity\Properties\Properties;
use QP\Viewports\Vendor\Psr\Container\ContainerInterface;

/**
 * @phpstan-import-type Service from \QP\Viewports\Vendor\Inpsyde\Modularity\Module\ServiceModule
 * @phpstan-import-type ExtendingService from \QP\Viewports\Vendor\Inpsyde\Modularity\Module\ExtendingModule
 */
class Package
{
    /**
